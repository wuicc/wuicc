<template>
  <div class="sumo-second-container">
    <!-- 加载状态 -->
                                ...
                                <v-col v-for="(skill, skillIndex) in lineup.skills" :key="skillIndex" cols="12">
                                  <v-card variant="tonal" color="accent" class="pa-1 mb-1">
                                    <div class="d-flex align-center">
                                      <v-img v-if="skill.icon" :src="skill.icon" width="24" height="24"
                                        class="mr-2"></v-img>
                                      <div>
                                        <div class="text-caption font-weight-bold">{{ skill.name }}</div>
                                        <div class="text-caption text-medium-emphasis">{{ removeColorTags(skill.desc) }}
                                        </div>
                                      </div>
                                    </div>
                                  </v-card>
