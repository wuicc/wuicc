<template>
  <div class="sumo-third-container">
    <!-- 加载状态 -->
    ...
    <div v-else>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-row>
            <v-col v-for="(record, index) in activityData.records" :key="record.challenge_id || index" cols="12">
                ...
                <v-card-title class="d-flex align-center justify-space-between">
                  <div>
                    ...
                    <div class="d-flex align-center mt-1">
                      ...
                      <v-chip v-if="record.score_multiple" size="small" color="info" variant="tonal">
  ...
  setup(props) {
    ...
    const getTotalScore = () => {
      ...
      return props.activityData.records.reduce((total, record) => {
        return total + (record.max_score || 0)
      }, 0)
    }
    ...
    const getTotalLineups = () => {
      if (!props.activityData?.records) return 0
      return props.activityData.records.reduce((total, record) => {
        return total + (record.lineups?.length || 0)
      }, 0)
    }
