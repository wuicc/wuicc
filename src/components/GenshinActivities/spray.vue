                      ...
                      <v-col v-for="(gallery, galleryIndex) in challenge.galleries" :key="galleryIndex" cols="12" md="6"
                        ...
                        <v-card variant="outlined" class="h-100">
                          ...
                          <v-card-text>
                            <!-- 角色信息 -->
                            <div class="mb-3">
                              <div class="text-caption font-weight-bold mb-1">角色阵容</div>
                              <v-row dense>
                            ...
                            <!-- 增益效果 -->
                            <div>
                              <div class="text-caption font-weight-bold mb-1">重熔效应</div>
                              <v-row dense>
                                <v-col v-for="(buff, buffIndex) in gallery.buffs" :key="buffIndex" cols="12">
                                  <v-card variant="tonal" color="accent" class="pa-1 mb-1">
                                    <div class="d-flex align-center">
                                      <v-img v-if="buff.icon" :src="buff.icon" width="24" height="24" class="mr-2 rounded-circle"
                                        style="background-color: #666;" max-width="24px"></v-img>
                                      <div>
